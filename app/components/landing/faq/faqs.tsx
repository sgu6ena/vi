...
const FAQS: IFaq[] = [
    {
        ...
        answer: <p>
            <strong>«Новогодний переполох»</strong> – это интерактивная игра для абонентов IDC, где каждый день разыгрываются денежные призы, смартфоны и подарки от партнёров. Чтобы выиграть, нужно всего лишь верно ответить на вопросы игры, посвящённые истории и традициям празднования Нового года и Рождества.
        </p>
    },
    {
    ...
    },
    {
        ...
        answer: <>
            ...
            <p> Чтобы играть, нужно позвонить на номер 1415 и правильно ответить на вопросы интерактивной игры. Если Вы играете на сайте 1415.idc.md или через мобильное приложение «Мой IDC», нажмите кнопку "Выиграть деньги" для начала игры.</p>
        </>
    }, {
        question: 'Сколько стоит участие в игре «Новогодний переполох»?',
        answer: <ol>
            <li>Стоимость одного сеанса игры (90 секунд) на web-странице 1415.idc.md составляет 7,00 рублей ПМР. Оплата и отсчет игрового времени начинается после нажатия кнопки «Играть».</li>
            <li>В течение игрового сеанса доступна докупка дополнительного времени (30 секунд). Стоимость дополнительного времени составляет 2,00 рубля ПМР.  Количество докупок времени не ограничено.</li>
            ...
            <li>При звонках на короткий номер «1415» с мобильной, фиксированной и проводной сети стоимость игры составляет 7,00 рублей. Тариф применяется за 1 минуту соединения. Продолжительность соединения округляется до полной минуты. Тарификация начинается после звукового сигнала.</li>
            <li>Для абонентов мобильной и проводной связи (авансовая форма оплаты) минимальная необходимая сумма средств на счете для доступа на номер «1415» составляет 16,00 рублей ПМР.</li>
            <li>Для абонентов мобильной и проводной связи (кредитная форма оплаты) кредитный лимит для доступа на номер «1415» должен составлять не менее 224,00 рублей ПМР.</li>
        </ol>
    }, {
        question: 'Как можно выиграть подарок от партнеров?',
        answer: <p>
            Получить подарки от партнёров можно, если Вы играете на сайте 1415.idc.md или в приложении «Мой IDC». Чтобы выиграть подарок, нужно правильно ответить на 9 вопросов подряд – система переведёт вас на страницу с подарками, которые спрятаны в мешках. Если Вы не выберите ни один из подарочных мешков, подарок аннулируется.
        </p>
    }, {
        question: 'Если выиграл подарок от партнёров, как его получить?',
        answer: <p>
            Если Вы выиграли подарок от партнёров, на следующий день с Вами свяжется менеджер-оператор и разъяснит условия получения подарка.
        </p>
    }, {
        question: 'Где и когда проводятся розыгрыши подарков?',
        answer: <>
          <p>  Розыгрыши 1000 рублей и смартфона проводятся ежедневно в период проведения интерактивной игры в 18:00 на сайте 1415.idc.md. Из лицевых счетов абонентов - участников игры, с помощью программы-генератора случайных чисел определяются лицевые счета 5 победителей. Список победителей размещается на сайте игры.</p>
          <p>  Обратите внимание, если Вы играли 7 декабря, Ваш лицевой счёт будет принимать участие в розыгрыше на следующий день, то есть 8 декабря. Розыгрыш призов по 1000 рублей за 26 декабря (последний день игры) состоится 27 декабря в 10:00 на сайте 1415.idc.md.</p>
          <p>  Розыгрыш главного приза 50 000 рублей состоится 27 декабря в 10.10 на сайте 1415.idc.md с помощью программы-генератора случайных чисел. Победитель выбирается  за весь период проведения интерактивной игры - с 7 по 26 декабря.</p>
        </>
    }, {
        question: 'На какую тему вопросы в интерактивной игре?',
        answer: <p>
            Мы подготовили интересные и простые вопросы о традициях и особенностях празднования Нового года и Рождества в разных уголках мира, вопросы о культуре и истории новогодних и рождественских праздников, новогодних фильмах и мультфильмах, песнях и танцах, любимых блюдах и напитках, а также много других занимательных вопросов по новогодней тематике.
        </p>
    }, {
